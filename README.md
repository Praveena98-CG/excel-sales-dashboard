...
!\[Sales Dashboard](dashboard\_screenshot.png)
...
|File|Description|
|-|-|
|`sales\\\\\\\_data.xlsx`|Excel workbook with raw data, PivotTables and Dashboard|
|`dashboard\\\\\\\_screenshot.png`|Screenshot of the completed dashboard|
